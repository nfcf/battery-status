...
public class ServCollectData extends Service {
	...
	private BroadcastReceiver networkReceiver = new BroadcastReceiver() {
		...
		public void onReceive(Context context, Intent intent) {
        	...
        	} else*/ if (networkType == TelephonyManager.NETWORK_TYPE_GPRS || networkType == TelephonyManager.NETWORK_TYPE_CDMA || networkType == TelephonyManager.NETWORK_TYPE_IDEN) {
	...
	private BroadcastReceiver phoneCallReceiver = new BroadcastReceiver() {
		...
		public void onReceive(Context context, Intent intent) {
			...
			db.setDatapoint(AppContext.PHONECALL, phoneCallState > 1 ? 1 : 0); //0 - IDLE; 1 - RINGING; 2 - CALL ESTABLISHED
